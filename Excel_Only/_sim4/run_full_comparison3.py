...
out = io.open(r"C:\Users\salva\Projects\FantaWarRoom\Excel_Only\_sim4\full_comparison_log3.txt", "w", encoding="utf-8")
results = {}
...
with io.open(r"C:\Users\salva\Projects\FantaWarRoom\Excel_Only\_sim4\full_comparison_results3.json", "w", encoding="utf-8") as f:
