...
out = io.open(r"C:\Users\salva\Projects\FantaWarRoom\Excel_Only\_sim4\full_comparison_log2.txt", "w", encoding="utf-8")
results = {}
...
with io.open(r"C:\Users\salva\Projects\FantaWarRoom\Excel_Only\_sim4\full_comparison_results2.json", "w", encoding="utf-8") as f:
