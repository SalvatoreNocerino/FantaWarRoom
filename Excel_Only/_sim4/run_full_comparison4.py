...
from engine4 import load_players, build_tiers, run_auction, STRATEGIE, BUDGET
...
out = io.open(r"C:\Users\salva\Projects\FantaWarRoom\Excel_Only\_sim4\full_comparison_log4.txt", "w", encoding="utf-8")
results = {}
...
with io.open(r"C:\Users\salva\Projects\FantaWarRoom\Excel_Only\_sim4\full_comparison_results4.json", "w", encoding="utf-8") as f:
