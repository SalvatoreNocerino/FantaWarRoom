...
# diagnostica: caso Anjorin-style, quanti FVM alti finiscono in fascia bassa
...
roster_sorted = sorted(t1team["roster"], key=lambda p: -p["fvm"])
print("Giocatori piu forti (fvm) e la fascia/prezzo pagato:")
for p in roster_sorted[:10]:
